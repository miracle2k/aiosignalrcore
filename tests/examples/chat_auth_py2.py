...
login_url = input_with_default(
    "Enter your server login url({0}):", "http://localhost:50746/account/token"
)
server_url = input_with_default(
    "Enter your server url(default: {0}): ", "ws://localhost:50746/hubs/chat"
)
username = input_with_default(
    "Enter your username (default: {0}): ", "mandrewcito@mandrewcito.com"
)
